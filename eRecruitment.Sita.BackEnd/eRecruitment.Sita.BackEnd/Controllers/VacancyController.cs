...
namespace eRecruitment.Sita.BackEnd.Controllers
{
    public class VacancyController : Controller
    {
        ...
        public ActionResult AddVacancy(HttpPostedFileBase postedFile, HttpPostedFileBase postedBusinessCase, VacancyModels model, FormCollection fc, IEnumerable<HttpPostedFileBase> files)
        {
            ...
            //Old Code with Single file upload
            ...
            if (Convert.ToDateTime(model.ClosingDate) <= DateTime.Now)
            {
            ...
            {
                //string DeligationReasons = this.RemoveSpecialCharacters(model.DeligationReasons);
                //string AdditonalRequirements = this.RemoveSpecialCharacters(model.AdditonalRequirements);
                //string VacancyPurpose = this.RemoveSpecialCharacters(model.VacancyPurpose);
                //string QualificationAndExperience = this.RemoveSpecialCharacters(model.QualificationAndExperience);
                //string TechComps = this.RemoveSpecialCharacters(model.TechComps);
                //string Disclaimer = this.RemoveSpecialCharacters(model.Disclaimer);
                ...
                //string LeadComps = this.RemoveSpecialCharacters(model.LeadComps);
                //string BehaveComps = this.RemoveSpecialCharacters(model.BehaveComps);
                ...
                //if (model.DeligationReasons != null) { DeligationReasons = model.DeligationReasons; } else { DeligationReasons = string.Empty; }
                //if (model.AdditonalRequirements != null) { AdditonalRequirements = model.AdditonalRequirements; } else { AdditonalRequirements = string.Empty; }
                //if (model.VacancyPurpose != null) { VacancyPurpose = model.VacancyPurpose; } else { VacancyPurpose = string.Empty; }
                //if (model.QualificationAndExperience != null) { QualificationAndExperience = model.QualificationAndExperience; } else { QualificationAndExperience = string.Empty; }
                //if (model.TechComps != null) { TechComps = model.TechComps; } else { TechComps = string.Empty; }
                //if (model.Disclaimer != null) { Disclaimer = model.Disclaimer; } else { Disclaimer = string.Empty; }
                //if (model.Responsibility != null) { Responsibility = model.Responsibility; } else { Responsibility = string.Empty; }
                //if (model.Knowledge != null) { Knowledge = model.Knowledge; } else { Knowledge = string.Empty; }
                //if (model.LeadComps != null) { LeadComps = model.LeadComps; } else { LeadComps = string.Empty; }
                //if (model.BehaveComps != null) { BehaveComps = model.BehaveComps; } else { BehaveComps = string.Empty; }
